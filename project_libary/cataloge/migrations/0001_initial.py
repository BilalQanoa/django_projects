    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genere', models.ManyToManyField(to='cataloge.genere')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statue', models.CharField(choices=[('m', 'Maintenence'), ('o', 'On Loan'), ('a', 'Avaliable'), ('r', 'Reserved')], default='m', max_length=20)),
